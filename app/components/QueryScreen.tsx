...
const ArchStrata = dynamic(() => import('./ArchStrata'), { ssr: false });
    ...
    return (
        <section className="query-screen">
            ...
            <div className="query-eyebrow">
                ...
                <span className="query-eyebrow-ver">v1.1</span>
            </div>
            ...
            <div className="logo-sub">
                Historical Documentary Engine · The Guardian API · AI
                Orchestration
            </div>

            <div className="query-form">
                <div className="query-label">Enter a historical query</div>
